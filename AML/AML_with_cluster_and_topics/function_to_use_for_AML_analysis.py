...
def kmeans_reattached_patient(cell_to_sample,files):
    ...
    overall_dataframe['Cell origin'] = cellular_origin
    return dataframe_for_LDA,overall_dataframe
